...
if __name__ == '__main__':
    ...
    prd_used = ['ANCHOR-2', 'CNN_DBs', 'CNN_TR08u', 'DisoRDPbind-protein', 'fMoRFpred', 'OPAL', 'MoRFchibi',
    ...
    for merged_class in ['c0', 'c1']:
        generate_output()
        with open(f"Data/results/Tables/Table_S07_Merge_{merged_class}_{files[0]}_{files[1]}.tsv", 'w') as fout:
