#!/usr/bin/env python3
"""
Supplementary Table S07 — AUC under class-merging strategies
(CAID1uh vs CAID23uh) for Class 0 and Class 1 merging.
...
if __name__ == '__main__':
    files = ['CAID1uh', 'CAID23uh']

    prd_used = [
        'ANCHOR-2', 'CNN_DBs', 'CNN_TR08u', 'DisoRDPbind-protein',
        'fMoRFpred', 'OPAL', 'MoRFchibi', 'MoRFchibi-light', 'MoRFchibi-web'
    ]

    files_dict = {
        'CAID1uh':  {'tag': 'binding_protein', 'predictors': {}},
    ...
    for merged_class in ['c0', 'c1']:
        ...
        out_file = f"Data/results/Tables/Table_S07_Merge_{merged_class}_{files[0]}_{files[1]}.tsv"
