...
# All values in Table 3 can be generated by running:
#   Figure_03Left.py (generates Table_3_u_all.tsv),
#   Figure_03_Right.py (generates Table_3_uh_SL.tsv), and
#   Figure_S03.py (generates Table_3_uh_all.tsv).
