#!/usr/bin/env python3
"""
Supplementary Table S06 — AUC under class-merging strategies
(CAID1uh vs DBsh) for Class 0 and Class 1 merging.
...
if __name__ == '__main__':
    ...
    prd_used = [
        'ANCHOR-2', 'CNN_C23u', 'CNN_TR08u', 'DisoRDPbind-protein',
    ...
    for merged_class in ['c0', 'c1']:
        ...
        out_file = f"Data/results/Tables/Table_S06_Merge_{merged_class}_{files[0]}_{files[1]}.tsv"
